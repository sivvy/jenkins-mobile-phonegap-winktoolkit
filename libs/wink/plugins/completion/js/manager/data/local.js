 ...
 * 
 * @methods:
 *  --> start: start the data manager
 *  --> stop: stop the data manager
 *  --> searchData: Run the local search process using the specified query string
 * 
 * @attributes:
 *  --> suggestions:                The suggestions data array
 *  --> minQueryLength:             The minimum query length
 *  --> maxSearchedSuggestions      The maximum searched suggestions count
 *  --> callbacks                   The array containing all processable callbacks
 *  --> removeDuplicateSuggestions  The boolean value that indicate if we have to remove duplicate suggestions
 * 
 * @properties:
 *  data =
 *  {
