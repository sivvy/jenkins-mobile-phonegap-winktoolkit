 ...
 *  --> searchData: Run the remote search process using the specified query string
 * 
 * @attributes:
 *  --> url:                        The Remote server URL to call
 *  --> queryParamName:             The query parameter name to use in the URL
 *  --> sendMethod:                 The send method to use (GET or POST)
 *  --> minQueryLength:             The minimum query length
 *  --> callbacks:                  The array containing all processable callbacks
 *  --> removeDuplicateSuggestions  The boolean that indicate if we have to remove duplicate suggestions
 * 
 * @properties:
 *  data =
 *  {
