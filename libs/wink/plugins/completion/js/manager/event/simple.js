 ...
 *  --> addMouseEventListenersOnNewSuggestion:  Append mouse listener to the DOM suggestion
 *  --> onInputBlur:                            Manage the onBlur event of the Component's input
 *  --> onInputKeyUp:                           Manage the onKeyUp event of the Component's input
 *  --> onInputKeyDown:                         Manage the onKeyUp event of the Component's input
 *  
 * @attributes:
 *  --> closeOnBlur:            Boolean that indicate if we have to close the completion on blur event
