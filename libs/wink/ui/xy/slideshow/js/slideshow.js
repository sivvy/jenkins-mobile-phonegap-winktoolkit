 ...
 *  data =
 * 	{
 * 		height:				the height of the slideshow
 *		width:				the with of the slideshow
 * 		items: 				An array of items ( item: { image: the image path, title: the item title, info: the items details })
 * 		position:			index of the displayed item in the item list
 * 		listeningTouch:		[optional] Indicates whether the component must listen to touch events (default: true)
 * 		touchTranslation:	[optional] Indicates whether a translation based on the user's touch must be performed (default: false)
 * 		withSliding:		[optional] Indicates whether the sliding mode is active (default: false)
 * 		withAnim:			[optional] Indicates whether the animation mode is active (default: false)
 * 		anims:				[optional] An array of named animation. Animation names : oneSquare, nSquare, fade, horizontalOut, horizontalIn, circleOut, circleIn, circlesOut, circlesIn, rowDown, rowUp, colLeft, colRight, rotate, spin, spinQuarter, light, wrap, scaleIn, scaleOut
 * 		animRandom:			[optional] Indicates whether a random selection of animation in the list must be done (default: false)
 * 		autoplay:			[optional] Indicates whether the autoplay mode is active (default: false)
 * 		autoplayDuration:	[optional] The duration between two displays of items (default: 5000)
 * 		slideDuration:		[optional] The duration of the slide (default: 200)
 * 		animDuration:		[optional] The duration of the animations (default: 800)
 * 		displayHeader:		[optional] Indicates whether the header is displayed (default: true)
 * 		displayFooter:		[optional] Indicates whether the footer is displayed (default: true)
 * 		headerHeight:		[optional] height of the header (default: 26)
 * 		footerHeight:		[optional] height of the footer (default: 26)
 * 		scopeSize:			[optional] number of loaded images around the current image (default: 4)
 * 	}
 * 
 * @methods:
 * 	--> getDomNode: Returns the Slideshow dom node
 *  --> getCurrentItem: Returns the current displayed item
 *  --> updateParameters: Updates the slideshow parameters
 ...
 * 
 * @events:
 *  --> /slideshow/events/animstart: the animation is starting
 *  --> /slideshow/events/animend: the animation is ending
 *  --> /slideshow/events/itemChanged: the item displayed has changed
 * 
 * @compatibility:
 * 	--> Iphone OS2, Iphone OS3, Android 1.5, Android 1.6, Android 2.2, Android 2.3, BlackBerry 6, Bada 1.0
 * 
 * @author:
 * 	--> Sylvain LALANDE
 */
...
define(['../../../../_amd/core', '../../../../ux/movementtracker/js/movementtracker'], function(wink)
{
	...
	wink.ui.xy.Slideshow.prototype = {
		 ...
		 * 
		 * @parameters:
		 * 	--> dx: the user touch delta on x-axis
		 * 	--> sx: the sliding delta on x-axis
		 */
		 ...
		 * 
		 * @parameters:
		 * 	--> scopeBegin: the begin of the scope
		 * 	--> scopeEnd: the end of the scope
		 */
	 ...
	 * 
	 * @properties:
	 *  A list of variables associated with their values. 
	 *  The value is a structure comprising the start value and end value of the variable, it has evolved over the stages of transition.
	 *  In addition, a special property named "StepCount" specify the number of stages of the transition.
	 *  eg: {
	 *  		stepCount: stepCount,
	 *  		x: { from: 0, to: 0 }
	 *  	}
	 ...
	 *  --> isFinished: 	returns true if the transition is finished
	 *  --> isOnDelay: 		returns true if the transition is waiting
	 *  --> getProperties:	returns the transition properties
	 * 
	 * @attributes:
	 * 	--> uId: unique identifier of the component
	 * 
	...
	wink.ui.xy.Slideshow.Transition.prototype = {
		...
		/**
		 * Returns true if the transition is waiting
		 */
		isOnDelay: function()
		{
