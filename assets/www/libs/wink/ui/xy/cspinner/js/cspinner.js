 ...
 * 		radius: 		the inner radius of the spinner,
 * 		thickness: 		the thickness of the spinner,
 * 		count: 			the number of parts,
 * 		space: 			the space between parts,
 * 		fromcolor: 		the begin color of the gradient,
 * 		tocolor: 		the end color of the gradient,
 * 		stopcolor: 		the stop position of the gradient,
