 ...
 * and _LIGHT_BG_IMAGE, you should comment the one you don't need
 * 
 * @methods:
 * 	--> getDomNode: Returns the main DOM node of the spinner
 * 
 * @attributes:
 * 	--> uId: unique identifier of the component
 * 	--> size: the size of the spinner (in pixels)
 * 	--> background: type of background (either "dark", "light" or "personal")
 * 	--> backgroundImage: the spinner image (in case the background was declared as "personal")
 * 
 * @properties:
 * 	{
 * 		background = type of background (either "dark", "light" or "personal")
