 ...
 * 
 * @methods:
 *  --> getHistoryData:         Return the history data for specified query
 *  --> saveHistoryData:        Save the suggestion data in history
 *  --> resetHistoryData:       Reset the history data
 *  
 * @attributes:
 *  --> storageName:            The history storage name
...
define(['../../../../../../_amd/core'], function(wink)
{
	...
	{    
	     ...
	     * 
	     * @return array Suggestions matching with the query
	     */
