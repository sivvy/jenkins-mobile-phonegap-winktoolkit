 ...
 * 
 * @methods:
 *  --> start:                  Start the history manager
 *  --> stop:                   Stop the history manager
 *  --> searchHistoryData:      Search and append the history data in the Component suggestion list
 *  --> saveHistoryData:        Save the suggestion in history
 *  --> resetHistory:           Reset the history data
 *  
 * @attributes:
 *  --> enable:                 The state of the history storage
 *  --> minQueryLength:         The minimum query length
 *  --> maxHistory:             The maximum history size
