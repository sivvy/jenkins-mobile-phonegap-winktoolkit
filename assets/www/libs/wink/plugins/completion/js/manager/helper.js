 ...
 * 
 * @methods:
 *  --> createModules:      Create default and additional modules for the manager
 *  --> startModules:       Start each module of the manager
 *  --> addModule:          Append a module in the manager's module array
 *  --> getDefaultModule:   Return the default module of the specified manager
 *  --> getModuleType:      Return the module type of the module instance
 *  --> isModuleType:       Check if the suggestion is with the type of the module
 *  
 * @winkVersion:
 *  --> 1.4.0
 *  
...
define(['../../../../_amd/core'], function(wink)
{
	...
	wink.plugins.completion.manager.ManagerHelper =
	{
	     ...
	     * 
	     * @return boolean Status of modules initialization
	     */
