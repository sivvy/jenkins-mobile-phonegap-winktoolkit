 ...
 * 
 * @methods:
 *  --> start:                  Start the DOM manager
 *  --> stop:                   Stop the DOM manager
 *  --> buildDomNode:           Build the DOM node using the internal suggestion of the Component
 *  --> showDomNode:            Show the DOM node
 *  --> hideDomNode:            Hide the DOM node
 *  --> highlight:              Highlight a specific DOM suggestion
 *  --> unhighlight:            Unhighlight all DOM suggestions
 *  --> updatePositions:        Update the size and the position of the DOM node
 *  --> getDomNode:             Return the DOM node
 *  --> getSuggestionDomNode:   Return the suggestion DOM node specified by the index
 *  
 * @attributes:
 *  --> domNode:                The DOM node HTMLElement
 *  --> callbacks:              The array containing all processable callbacks
 *  --> cssPrefix:              The CSS prefix used for all HTMLElement
 *  --> borderSize:             The CSS border size value
 * 
 * @properties:
 *  data =
 *  {
