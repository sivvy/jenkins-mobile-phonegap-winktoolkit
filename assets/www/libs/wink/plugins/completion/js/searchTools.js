 ...
 * 
 * @methods:
 *  --> stripAccents:           Remove all accents and replace them by normal letter
 *  --> stripSeparatorChars:    Remove separator chars
 *  --> clearSpace:             Trim left and right and remove multiple space on the string
 *  --> getBoldInv:             Invert bold a string with the specified pattern
 *  
 * @winkVersion:
 *  --> 1.4.0
 *  
...
define(['../../../_amd/core'], function(wink)
{
	...
	{	    
	     ...
	     * 
	     * @return string the revert bolded string
	     */
